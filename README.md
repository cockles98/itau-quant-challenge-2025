...
Equity curves (The strategy starts generating out-of-sample results on **30 March 2020**, because the data between **14 Sep 2017**, and that date are only used to train the first block of the walk-forward):
